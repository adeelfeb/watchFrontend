...
// const ToastNotification = ({ message, duration, onClose, position = 'right' }) => {
...
//         bg-green-500 bg-opacity-80 text-white p-2 rounded-lg shadow-lg flex items-center space-x-4 
//         w-90 max-w-full transition-all transform ${show ? 'translate-x-0 opacity-100' : 'translate-x-8 opacity-0'} 
//         ease-out duration-500
//         ring-2 ring-green-300 ring-opacity-40 ring-offset-2 
//         backdrop-blur-sm hover:backdrop-blur-md`}
//       style={{
//         opacity: show ? 1 : 0,
//         boxShadow: '0 4px 10px rgba(0, 255, 0, 0.4), 0 0 20px rgba(0, 255, 0, 0.6)',
//       }}
//     >
...
//         }}
//         className="ml-auto text-white p-2 bg-transparent hover:bg-green-700 rounded-full focus:outline-none"
//       >
//         <MdClose size={20} />
//       </button>
//     </div>
